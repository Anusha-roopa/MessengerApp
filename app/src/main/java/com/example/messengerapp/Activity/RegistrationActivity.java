...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if(imageUri!=null)
                        {
                            ...
                            String staus1 ="Hey There I'm Using This Application";
                            ...
                            Users users=new Users(auth.getUid(),name,email,imageURI, staus1);
        ...
        txt_signin.setOnClickListener(v -> startActivity(new Intent(RegistrationActivity.this, LoginActivity.class)));
